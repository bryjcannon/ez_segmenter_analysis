...
##### 1a) LOAD ezSeg DATA #####
  ...
  ez_folder <- '/Volumes/BryJC_Stanford/For_Ez_Segmentor/HiResTMA/PD_Panel/'
  setwd(ez_folder)
  # specify run folders
  ezRun <- c('ezSegResults_tma_PDpanel')
  ezRunsShort = c('PD') # if same region for multiuple runs, write that region # run times
